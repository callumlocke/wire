...
/**
 * Any object that may easily be 'cast' into a proper Filemap.
 */
export type FilemapLike = ImmutableMap<string, Buffer | string> | { [key: string]: Buffer | string }
 ...
 */
export type Matchable = RegExp | Array<string> | string | void | null | ((name: string) => any)
...
export type PluginFunction = (name: 'babel' | 'tmp' | 'run', ...args: any) => AsyncTransform
